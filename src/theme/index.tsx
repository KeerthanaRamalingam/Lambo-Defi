...
export function colors(darkMode: boolean): Colors {
  return {
    ...
    bg3: darkMode ? '#40444F' : '#000000',
    bg4: darkMode ? '#565A69' : '#CED0D9',
    bg5: darkMode ? '#6C7284' : '#000000',
    ...
    primary3: darkMode ? '#4D8FEA' : '#000000',
    primary4: darkMode ? '#376bad70' : '#FFFFFF',
    primary5: darkMode ? '#153d6f70' : '#000000',

    // color text
    primaryText1: darkMode ? '#6da8ff' : '#FFFFFF',

    // secondary colors
    secondary1: darkMode ? '#2172E5' : '#000000',
    secondary2: darkMode ? '#17000b26' : '#F6DDE8',
    secondary3: darkMode ? '#17000b26' : '#000000',
...
export const TYPE = {
  ...
  italic(props: TextProps) {
    return <TextWrapper fontWeight={500} fontSize={12} fontStyle={'italic'} color={'text1'} {...props} />
  },
